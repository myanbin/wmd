...
Attacklab.wmdBase = function(){
	...
	// entering links.
	var imageDialogText = "<p style='margin-top: 0px'><b>输入图片链接</b></p><p>你也可以为此图片添加一个可选的标题。如:</p><p>http://example.com/images/sky.jpg \"title\"</p>";
	var linkDialogText = "<p style='margin-top: 0px'><b>输入网页链接</b></p><p>你也可以为此链接添加一个可选的标题。如:</p><p>http://example.com/ \"title\"</p>";
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var makeSpritedButtonRow = function(){
			...
			boldButton.title = "粗体 <strong> Ctrl+B";
			...
			italicButton.title = "斜体 <em> Ctrl+I";
